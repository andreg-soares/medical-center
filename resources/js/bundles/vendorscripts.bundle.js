        ...
        p.VERSION = "1.12.4", p.DEFAULTS = {
            ...
            constructor: p, init: function () {
                ...
                return E.each(function (e) {
                    ...
                    if (y++, !t.hasClass("bs-title-option")) {
                        var i, n = this.className || "", s = k(this.style.cssText),
                            ...
                            d = t.parent(), c = "OPTGROUP" === d[0].tagName, h = c && d[0].disabled,
                            p = this.disabled || h;
                ...
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var u = a.offsetHeight, f = l ? l.offsetHeight : 0, m = d ? d.offsetHeight : 0,
                        g = c ? c.offsetHeight : 0, v = h ? h.offsetHeight : 0, b = T(s).outerHeight(!0),
                ...
                if (this.findLis(), this.liHeight(), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size) {
                    var o, a, r, l, d, c, h, p, u = this, f = this.$menu, m = this.$menuInner, s = T(window),
                        g = this.$newElement[0].offsetHeight, v = this.$newElement[0].offsetWidth,
                        b = this.sizeInfo.liHeight, $ = this.sizeInfo.headerHeight, w = this.sizeInfo.searchHeight,
                        x = this.sizeInfo.actionsHeight, y = this.sizeInfo.doneButtonHeight,
                        e = this.sizeInfo.dividerHeight, C = this.sizeInfo.menuPadding, S = this.sizeInfo.menuExtras,
                        t = this.options.hideDisabled ? ".disabled" : "", E = function () {
                ...
                t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
                    ...
                    if (w.multiple && 1 !== w.options.maxOptions && e.stopPropagation(), e.preventDefault(), !w.isDisabled() && !t.parent().hasClass("disabled")) {
                        var a = w.$element.find("option"), r = a.eq(i), l = r.prop("selected"),
                            d = r.parent("optgroup"), c = w.options.maxOptions, h = d.data("maxOptions") || !1;
                        if (w.multiple) {
                            if (r.prop("selected", !l), w.setSelected(i, !l), t.blur(), !1 !== c || !1 !== h) {
                                ...
                                if (c && p || h && u) if (c && 1 == c) a.prop("selected", !1), r.prop("selected", !0), w.$menuInner.find(".selected").removeClass("selected"), w.setSelected(i, !0); else if (h && 1 == h) {
                                    ...
                                    var m = "string" == typeof w.options.maxOptionsText ? [w.options.maxOptionsText, w.options.maxOptionsText] : w.options.maxOptionsText,
                                        g = "function" == typeof m ? m(c, h) : m, v = g[0].replace("{n}", c),
                                        b = g[1].replace("{n}", h), $ = T('<div class="notify"></div>');
